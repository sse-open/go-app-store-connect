...
import (
	...
	client "github.com/sse-open/go-app-store-connect/client"
...
func (_m *IInAppPurchaseService) ListAppInAppPurchases(ctx context.Context, appID string, queryParams *inapppurchase.ListAppInAppPurchasesQuery) (*inapppurchase.InAppPurchasesV2Response, *client.ClientResponse, error) {
	...
	var r1 *client.ClientResponse
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *inapppurchase.ListAppInAppPurchasesQuery) (*inapppurchase.InAppPurchasesV2Response, *client.ClientResponse, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *inapppurchase.ListAppInAppPurchasesQuery) *client.ClientResponse); ok {
		r1 = rf(ctx, appID, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*client.ClientResponse)
		}
	}
...
func (_c *IInAppPurchaseService_ListAppInAppPurchases_Call) Return(_a0 *inapppurchase.InAppPurchasesV2Response, _a1 *client.ClientResponse, _a2 error) *IInAppPurchaseService_ListAppInAppPurchases_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IInAppPurchaseService_ListAppInAppPurchases_Call) RunAndReturn(run func(context.Context, string, *inapppurchase.ListAppInAppPurchasesQuery) (*inapppurchase.InAppPurchasesV2Response, *client.ClientResponse, error)) *IInAppPurchaseService_ListAppInAppPurchases_Call {
	_c.Call.Return(run)
	return _c
}

// ListInAppPurchaseAutomaticPrices provides a mock function with given fields: ctx, inAppPurchaseID, queryParams
func (_m *IInAppPurchaseService) ListInAppPurchaseAutomaticPrices(ctx context.Context, inAppPurchaseID string, queryParams *inapppurchase.ListInAppPurchaseAutomaticPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error) {
	...
	var r1 *client.ClientResponse
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *inapppurchase.ListInAppPurchaseAutomaticPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *inapppurchase.ListInAppPurchaseAutomaticPricesQuery) *client.ClientResponse); ok {
...
func (_c *IInAppPurchaseService_ListInAppPurchaseAutomaticPrices_Call) Return(_a0 *inapppurchase.InAppPurchasePricesResponse, _a1 *client.ClientResponse, _a2 error) *IInAppPurchaseService_ListInAppPurchaseAutomaticPrices_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IInAppPurchaseService_ListInAppPurchaseAutomaticPrices_Call) RunAndReturn(run func(context.Context, string, *inapppurchase.ListInAppPurchaseAutomaticPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error)) *IInAppPurchaseService_ListInAppPurchaseAutomaticPrices_Call {
	_c.Call.Return(run)
	return _c
}

// ListInAppPurchaseManualPrices provides a mock function with given fields: ctx, inAppPurchaseID, queryParams
func (_m *IInAppPurchaseService) ListInAppPurchaseManualPrices(ctx context.Context, inAppPurchaseID string, queryParams *inapppurchase.ListInAppPurchaseManualPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error) {
	ret := _m.Called(ctx, inAppPurchaseID, queryParams)
	...
	var r1 *client.ClientResponse
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *inapppurchase.ListInAppPurchaseManualPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error)); ok {
		return rf(ctx, inAppPurchaseID, queryParams)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *inapppurchase.ListInAppPurchaseManualPricesQuery) *client.ClientResponse); ok {
		r1 = rf(ctx, inAppPurchaseID, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*client.ClientResponse)
...
func (_c *IInAppPurchaseService_ListInAppPurchaseManualPrices_Call) Return(_a0 *inapppurchase.InAppPurchasePricesResponse, _a1 *client.ClientResponse, _a2 error) *IInAppPurchaseService_ListInAppPurchaseManualPrices_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IInAppPurchaseService_ListInAppPurchaseManualPrices_Call) RunAndReturn(run func(context.Context, string, *inapppurchase.ListInAppPurchaseManualPricesQuery) (*inapppurchase.InAppPurchasePricesResponse, *client.ClientResponse, error)) *IInAppPurchaseService_ListInAppPurchaseManualPrices_Call {
	_c.Call.Return(run)
	return _c
}
