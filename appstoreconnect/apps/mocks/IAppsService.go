...
func (_m *IAppsService) ListApps(ctx context.Context, queryParams *apps.ListAppsQuery) (*apps.AppsResponse, *client.ClientResponse, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *apps.ListAppsQuery) (*apps.AppsResponse, *client.ClientResponse, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *apps.ListAppsQuery) *client.ClientResponse); ok {
...
func (_c *IAppsService_ListApps_Call) Return(_a0 *apps.AppsResponse, _a1 *client.ClientResponse, _a2 error) *IAppsService_ListApps_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IAppsService_ListApps_Call) RunAndReturn(run func(context.Context, *apps.ListAppsQuery) (*apps.AppsResponse, *client.ClientResponse, error)) *IAppsService_ListApps_Call {
	_c.Call.Return(run)
	return _c
}
