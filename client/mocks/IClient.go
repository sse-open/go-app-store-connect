...
func (_m *IClient) Delete(ctx context.Context, path string) (*client.ClientResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*client.ClientResponse, error)); ok {
		return rf(ctx, path)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *client.ClientResponse); ok {
		r0 = rf(ctx, path)
	} else {
		if ret.Get(0) != nil {
...
func (_c *IClient_Delete_Call) Return(_a0 *client.ClientResponse, _a1 error) *IClient_Delete_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IClient_Delete_Call) RunAndReturn(run func(context.Context, string) (*client.ClientResponse, error)) *IClient_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, path, query, respPayload
func (_m *IClient) Get(ctx context.Context, path string, query interface{}, respPayload interface{}) (*client.ClientResponse, error) {
	...
	var r0 *client.ClientResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, interface{}, interface{}) (*client.ClientResponse, error)); ok {
		return rf(ctx, path, query, respPayload)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, interface{}, interface{}) *client.ClientResponse); ok {
...
func (_c *IClient_Get_Call) Return(_a0 *client.ClientResponse, _a1 error) *IClient_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IClient_Get_Call) RunAndReturn(run func(context.Context, string, interface{}, interface{}) (*client.ClientResponse, error)) *IClient_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Patch provides a mock function with given fields: ctx, path, body, respPayload
func (_m *IClient) Patch(ctx context.Context, path string, body *client.AppStoreConnectRequestPayload, respPayload interface{}) (*client.ClientResponse, error) {
	...
	var r0 *client.ClientResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *client.AppStoreConnectRequestPayload, interface{}) (*client.ClientResponse, error)); ok {
		return rf(ctx, path, body, respPayload)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *client.AppStoreConnectRequestPayload, interface{}) *client.ClientResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *client.AppStoreConnectRequestPayload, interface{}) error); ok {
...
//   - ctx context.Context
//   - path string
//   - body *client.AppStoreConnectRequestPayload
//   - respPayload interface{}
...
func (_c *IClient_Patch_Call) Run(run func(ctx context.Context, path string, body *client.AppStoreConnectRequestPayload, respPayload interface{})) *IClient_Patch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*client.AppStoreConnectRequestPayload), args[3].(interface{}))
	})
	return _c
}

func (_c *IClient_Patch_Call) Return(_a0 *client.ClientResponse, _a1 error) *IClient_Patch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IClient_Patch_Call) RunAndReturn(run func(context.Context, string, *client.AppStoreConnectRequestPayload, interface{}) (*client.ClientResponse, error)) *IClient_Patch_Call {
	_c.Call.Return(run)
	return _c
}

// Post provides a mock function with given fields: ctx, path, body, respPayload
func (_m *IClient) Post(ctx context.Context, path string, body *client.AppStoreConnectRequestPayload, respPayload interface{}) (*client.ClientResponse, error) {
	ret := _m.Called(ctx, path, body, respPayload)
...
func (_c *IClient_Post_Call) Run(run func(ctx context.Context, path string, body *client.AppStoreConnectRequestPayload, respPayload interface{})) *IClient_Post_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*client.AppStoreConnectRequestPayload), args[3].(interface{}))
	})
	return _c
...
func (_c *IClient_Post_Call) Return(_a0 *client.ClientResponse, _a1 error) *IClient_Post_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IClient_Post_Call) RunAndReturn(run func(context.Context, string, *client.AppStoreConnectRequestPayload, interface{}) (*client.ClientResponse, error)) *IClient_Post_Call {
	_c.Call.Return(run)
	return _c
}
